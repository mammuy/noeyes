...
export default class Slider extends Component {
    ...
    handleWheel = (event) => {
        ...
        this.setState({ level: this.cap((this.state.level * 1) + Math.round(event.deltaY * -1 * 0.01 * (this.props.scrollAmount !== undefined ? this.props.scrollAmount : 1))) }, this.fireChange)
    }
